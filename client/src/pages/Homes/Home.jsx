...
const Home = () => {
  return (
    <div className="home-container">
      ...
      <Section/>
      <Reviews />
      <Paragraph styles="paragraph-btn" logo='false'  url="../../../public/nrj.png" title="Énergie et Excellence : Des  " spanText="Intervenants d'Élite" text="Découvrez le privilège d'avoir des sportifs d'exception, des championnes inspirantes et des coachs de renom à vos événements ! Plongez dans l'univers de l'élite sportive, recevez des conseils exclusifs et boostez la motivation de votre équipe. Tendances.Events, là où chaque intervention crée l'étincelle de la réussite. Faites de votre événement une expérience inoubliable !" btnText="Découvrez nos sportifs" className="nosSport"/>
